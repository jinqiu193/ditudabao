...
def index():
    ...
    <head>
        ...
        <style>
            ...
            .container { /* 新增容器 */
                ...
                width: 100%;
                position: relative; /* 添加相对定位，使按钮可绝对定位 */
            }
            /* 添加快捷方式按钮样式 */
            .shortcut-button {
                position: absolute;
                right: 20px;
                top: 20px;
                background-color: #28a745; /* 绿色按钮区分于主要操作 */
                color: white;
                padding: 12px 20px;
                border-radius: 5px;
                text-decoration: none;
                transition: background-color 0.3s ease;
                width: 160px; /* 固定宽度，确保矩形外观 */
                height: 40px; /* 固定高度 */
                text-align: center;
    ...
    <body>
        <div class="container"> <!-- 使用容器包裹内容 -->
            <h1>地图压缩包处理工具</h1>
            <!-- 蜂鸟地图账号中心快捷方式 -->
            <a href="https://account.fengmap.com/home" target="_blank" class="shortcut-button">访问蜂鸟地图账号中心</a>
            <h2>合并地图与主题包</h2>
